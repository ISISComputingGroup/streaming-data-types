...
impl<'a> Event44Message<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: ::flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.pixel_id { builder.add_pixel_id(x); }
    if let Some(x) = args.time_of_flight { builder.add_time_of_flight(x); }
    if let Some(x) = args.reference_time_index { builder.add_reference_time_index(x); }
  ...
  pub fn source_name(&self) -> &'a str {
    ...
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<&str>>(Event44Message::VT_SOURCE_NAME, None).unwrap()}
  }
  #[inline]
  pub fn message_id(&self) -> i64 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i64>(Event44Message::VT_MESSAGE_ID, Some(0)).unwrap()}
  }
  #[inline]
  pub fn reference_time(&self) -> ::flatbuffers::Vector<'a, i64> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i64>>>(Event44Message::VT_REFERENCE_TIME, None).unwrap()}
  }
  #[inline]
  pub fn reference_time_index(&self) -> ::flatbuffers::Vector<'a, i32> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(Event44Message::VT_REFERENCE_TIME_INDEX, None).unwrap()}
  }
  #[inline]
  pub fn time_of_flight(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(Event44Message::VT_TIME_OF_FLIGHT, None)}
  }
  #[inline]
  pub fn pixel_id(&self) -> Option<::flatbuffers::Vector<'a, i32>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, i32>>>(Event44Message::VT_PIXEL_ID, None)}
  }
}
...
impl ::flatbuffers::Verifiable for Event44Message<'_> {
  ...
  fn run_verifier(
    ...
    v.visit_table(pos)?
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i64>>>("reference_time", Self::VT_REFERENCE_TIME, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>("reference_time_index", Self::VT_REFERENCE_TIME_INDEX, true)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>("time_of_flight", Self::VT_TIME_OF_FLIGHT, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, i32>>>("pixel_id", Self::VT_PIXEL_ID, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> Event44MessageBuilder<'a, 'b, A> {
  ...
  pub fn add_source_name(&mut self, source_name: ::flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Event44Message::VT_SOURCE_NAME, source_name);
  }
  #[inline]
  pub fn add_message_id(&mut self, message_id: i64) {
    self.fbb_.push_slot::<i64>(Event44Message::VT_MESSAGE_ID, message_id, 0);
  }
  #[inline]
  pub fn add_reference_time(&mut self, reference_time: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , i64>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Event44Message::VT_REFERENCE_TIME, reference_time);
  }
  #[inline]
  pub fn add_reference_time_index(&mut self, reference_time_index: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Event44Message::VT_REFERENCE_TIME_INDEX, reference_time_index);
  }
  #[inline]
  pub fn add_time_of_flight(&mut self, time_of_flight: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Event44Message::VT_TIME_OF_FLIGHT, time_of_flight);
  }
  #[inline]
  pub fn add_pixel_id(&mut self, pixel_id: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b , i32>>) {
    self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(Event44Message::VT_PIXEL_ID, pixel_id);
  }
  #[inline]
  pub fn new(_fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>) -> Event44MessageBuilder<'a, 'b, A> {
  ...
  pub fn finish(self) -> ::flatbuffers::WIPOffset<Event44Message<'a>> {
    ...
    self.fbb_.required(o, Event44Message::VT_SOURCE_NAME,"source_name");
    self.fbb_.required(o, Event44Message::VT_REFERENCE_TIME,"reference_time");
    self.fbb_.required(o, Event44Message::VT_REFERENCE_TIME_INDEX,"reference_time_index");
...
pub fn root_as_event_44_message(buf: &[u8]) -> Result<Event44Message<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub fn size_prefixed_root_as_event_44_message(buf: &[u8]) -> Result<Event44Message<'_>, ::flatbuffers::InvalidFlatbuffer> {
...
pub unsafe fn root_as_event_44_message_unchecked(buf: &[u8]) -> Event44Message<'_> {
  unsafe { ::flatbuffers::root_unchecked::<Event44Message>(buf) }
}
#[inline]
...
pub unsafe fn size_prefixed_root_as_event_44_message_unchecked(buf: &[u8]) -> Event44Message<'_> {
  unsafe { ::flatbuffers::size_prefixed_root_unchecked::<Event44Message>(buf) }
}
...
#[inline]
pub fn finish_size_prefixed_event_44_message_buffer<'a, 'b, A: ::flatbuffers::Allocator + 'a>(fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>, root: ::flatbuffers::WIPOffset<Event44Message<'a>>) {
